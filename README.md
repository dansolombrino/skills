...
machine-local; follow the bundled `$flywheel` Codex setup guidance and verify a canonical project
root before any graph write. Flywheel is the curated lineage authority, while `index.md` is only
its local mirror.
