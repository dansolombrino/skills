...
Web connector hosts can still use OAuth-style connector flows. Use the host-native connector
installation UI and enter `https://flywheel.paradigma.inc/mcp-server` when prompted.
